...
from lib.first import First
from lib.lexicographic import Lexicographic
...
class MyApp(MONAILabelApp):
    ...
    def init_strategies(self) -> Dict[str, Strategy]:
        strategies: Dict[str, Strategy] = {
            "random": Random(),
            "first": First(self.last_image),
            "lexicographic": Lexicographic(self.last_image),
        }
...
"""
Example to run train/infer/scoring task(s) locally without actually running 
MONAI Label Server
"""
...
def main():
    ...
    settings.MONAI_LABEL_DATASTORE_FILE_EXT = [
        "*.png",
        "*.jpg",
        "*.jpeg",
        ".nii",
    ...
    app = MyApp(
        app_dir, studies, {"preload": "true", "models": "spleen_ct_segmentation"}
    )
    train(app)
